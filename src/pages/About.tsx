function About() {
  return (
    <section className="bg-nav-blue relative flex h-200 w-full flex-col bg-cover md:h-195 lg:h-210 xl:h-200 2xl:h-230">
      <div className="font-snow relative">
        <p className="mt-[18vh] text-center text-4xl sm:mt-[28vh] sm:text-5xl md:mt-[28vh] lg:mt-[24vh] lg:text-[56px] xl:mt-[28vh] xl:text-[64px] 2xl:mt-[24vh] 2xl:text-[96px]">
          ABOUT
        </p>
      </div>
      ...
      <div className="relative mx-auto w-full">
        ...
        <div className="absolute inset-0 top-[10vh] left-[9vw] ml-[7vw] flex md:top-[12vh] md:left-[0vw] 2xl:top-[10vh] 2xl:-left-[2vw]">
          <div className="flex flex-row rounded-md md:h-[65vh] md:w-[86vw] md:bg-blue-100 xl:h-[68vh] xl:w-[88vw] 2xl:h-[64vh] 2xl:w-[88vw]">
            <div className="relative top-[16vh] left-[4vw] flex w-[60vw] flex-col sm:left-[6vw] sm:w-[55vw] md:left-[8vw] md:w-[70vw] xl:top-[20vh] xl:left-[23vw] xl:w-[61vw] 2xl:w-[64vw]">
              <div className="font-odor z-12 mb-[6vh] text-center xl:text-[20px] 2xl:mb-[3vh] 2xl:text-[28px]">
        ...
        <div className="absolute top-[73vh] left-[3vw] z-10 w-[40vw] sm:top-[52vh] sm:left-[3vw] sm:w-[28vw] md:top-[46vh] md:left-[3vw] md:w-[28vw] lg:top-[40vh] lg:left-[1vw] lg:w-[24vw] xl:top-[22vh] xl:left-[8vw] xl:w-[17vw] 2xl:top-[18vh] 2xl:left-[7vw]">
        ...
        <img
          src="/frame.webp"
          alt="frame"
          className="relative z-0 ml-5 hidden md:top-[2vh] md:block md:h-[96vh] md:w-[95vw] xl:h-[100vh] xl:w-[98vw] 2xl:h-[90vh] 2xl:w-[98vw]"
        />
